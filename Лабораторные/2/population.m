                ...
                for j=1:obj.ChromosomeCount
                    if(rand() <= p)            
                        ...
                        for k=1:m-1
                            ...
                            temp = obj.Population(i).Chromosomes(j, leftBorder:rightBorder);
                            obj.Population(i).Chromosomes(j, leftBorder:rightBorder) = obj.Population(i+1).Chromosomes(j, leftBorder:rightBorder);
                            obj.Population(i+1).Chromosomes(j, leftBorder:rightBorder) = temp;
                        end
                    end
                end
